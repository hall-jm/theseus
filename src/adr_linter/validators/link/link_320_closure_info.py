# -*- coding: utf-8 -*-
# !/usr/bin/env python3
# src/adr_linter/validators/link/link_320_closure_info.py

"""
ADR-LINK-320 — Supersede closure: multiple descendants (informational).
Ref: ADR-0001 §10.4
"""
...
def validate_link_320_closure_info(
