# -*- coding: utf-8 -*-
# !/usr/bin/env python3
# src/adr_linter/validators/link/link_202_pointer_section_missing.py

"""
ADR-LINK-202 — Pointer to section key missing in base (warning).
...
(those are checked by ADR-LINK-204).

Ref: ADR-0001 §10.3 · ADR-LINK-202
"""
...
def validate_link_202_pointer_section_missing(ctx, rpt) -> None:
    meta = ctx.meta
    path = ctx.path
    si = ctx.section_info
    idx = ctx.all_idx
